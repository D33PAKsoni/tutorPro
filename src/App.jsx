...
// Shows when profile fetch failed (network/timeout) — not a DB config issue.
  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', alignItems:'center',
      ...
      <span className="material-symbols-outlined"
        style={{ fontSize:'3rem', color:'var(--primary)', opacity:0.4 }}>cloud_off</span>
...
function RequireAuth({ children, role }) {
  ...
  // Profile fetch failed — show retry, not login
  if (profileError) return <ProfileRetry onRetry={refreshProfile} />;
  // Profile null without error = DB trigger not set up (real config issue)
